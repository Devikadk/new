...
munit testing
how to run:-
 gcc -Wall -I/usr/include/libxml2  -o hlo insertion_test_munit.c ../BMD/xml_parsing.c ../DB-ACCESS/insertion.c  `mysql_config --cflags --libs` -lxml2  ${INCLUDE} munit.c
 */

//Setup Function
static void *insert_setup(const MunitParameter params[], void *user_data)
{
   char *doc = "/home/devika/Desktop/bmd.xml";
