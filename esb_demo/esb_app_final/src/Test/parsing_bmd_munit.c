...
/* Test setup function creates bmd and returns it 
   munit testing
 * how to run:-
    gcc -Wall -I/usr/include/libxml2  -o hello parsing_bmd_munit.c ../BMD/xml_parsing.c  -lxml2 ${INCLUDE} munit.c
*/
...
{
   char *doc = "../BMD/Testcases_extract_bmd/bmd.xml";
   bmd *b = (bmd*)malloc(sizeof(bmd));
...
{
   char *doc = "../BMD/Testcases_extract_bmd/bmd1.xml";
   bmd *b = (bmd*)malloc(sizeof(bmd));
   b->envelop_value = extract_envelop(doc);
   b->payload = extract_payload(doc);
   return b;
...
{
   char *doc = "../BMD/Testcases_extract_bmd/bmd2.xml";
   bmd *b = (bmd*)malloc(sizeof(bmd));
   b->envelop_value = extract_envelop(doc);
   b->payload = extract_payload(doc);
   return b;
...
{
   char *doc = "../BMD/Testcases_extract_bmd/bmd3.xml";
   bmd *b = (bmd*)malloc(sizeof(bmd));
   b->envelop_value = extract_envelop(doc);
   b->payload = extract_payload(doc);
   return b;
...
{
   char *doc = "../BMD/Testcases_extract_bmd/bmd4.xml";
   bmd *b = (bmd*)malloc(sizeof(bmd));
   b->envelop_value = extract_envelop(doc);
   b->payload = extract_payload(doc);
   return b;
