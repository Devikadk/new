...
* sql query :INSERT INTO esb_request(sender_id,dest_id,message_type,reference_id, message_id,data_location,received_on,status,status_details) values(?,?,?,?,?,?,CURRENT_TIMESTAMP,?,?)
*
